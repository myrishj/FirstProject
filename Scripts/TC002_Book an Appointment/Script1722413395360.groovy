...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/button_Make Appointment'))
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Successful Booking')
...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/button_Go to Homepage'))
